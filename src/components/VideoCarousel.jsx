  ...
  return (
    <>
      ...
      <div className="relative flex-center mt-10">
        <div className="flex-center bg-gray-300 px-7 py-5 background-blur rounded-full">
          {
        ...
        <button 
          ...
          className={!isLastVideo? "brightness-50 control-btn": "brightness-100 control-btn"}>
          <img 
            src={replayImg}
            alt={"replay"}
